...
@section('title', 'WORKER RELATIONSHIP | CREATE')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Worker Relationship | Create</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('worker-relationship.index') }}">Worker Relationship</a></li>
                        <li class="breadcrumb-item active">Create Worker Relationship</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container">
            <div class="card ">
                ...
                @endif
                <form method="POST" action="{{ route('worker-relationship.store') }}">
                    @csrf
                    <div class="card-body">
