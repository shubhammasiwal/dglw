...
@section('title', 'ADDRESS TYPE | CREATE')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Address Type | Create</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('address-type.index') }}">Address Type</a></li>
                        <li class="breadcrumb-item active">Create Address Type</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container">
            <div class="card ">
                ...
                @endif
                <form method="POST" action="{{ route('address-type.store') }}">
                    @csrf
                    <div class="card-body">
