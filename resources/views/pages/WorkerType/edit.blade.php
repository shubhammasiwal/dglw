...
@section('title', 'WORKER TYPE | EDIT')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Worker Type | Edit</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('worker-type.index') }}">Worker Type</a></li>
                        <li class="breadcrumb-item active">Edit Worker Type</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container">
            <div class="card ">
                ...
                @endif
                <form method="POST" action="{{ route('worker-type.update', $worker_type->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror" id="inputCode"
                                name="code" placeholder="Enter Code" value="{{ old('code', $worker_type->codeDirectory->code) }}">
                            @error('code')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="inputName"
                                name="name" placeholder="Enter Name" value="{{ old('name', $worker_type->name) }}">
                            @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
