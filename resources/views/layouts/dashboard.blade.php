...
<head>
    ...
    <script data-cfasync="false" nonce="ff10dfcf-a478-4c9b-a4db-502a7541c2fb">
        try {
            (function(w, d) {
                ! function(bz, bA, bB, bC) {
                    if (bz.zaraz) console.error("zaraz is loaded twice");
                        ...
                        bz.zaraz._v = "5853";
                        bz.zaraz._n = "ff10dfcf-a478-4c9b-a4db-502a7541c2fb";
                        bz.zaraz.q = [];
                        ...
                        bz.zaraz.init = () => {
                            ...
                            bH.src = "{{ asset('vendor/cdn-cgi/zaraz/js/s.js') }}" + "?z=" + btoa(encodeURIComponent(JSON.stringify(bz[bB])));
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('images/profile_picture_101.jpg') }}" alt="AdminLTELogo" height="60"
                width="60">
        </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ asset('images/profile_picture_101.jpg') }}" alt="User Avatar"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('images/profile_picture_101.jpg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('images/profile_picture_101.jpg') }}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="direct-chat-messages">
                                        ...
                                        <div class="direct-chat-msg">
                                            ...
                                            <!-- /.direct-chat-infos -->
                                            <img class="direct-chat-img" src="{{ asset('images/profile_picture_101.jpg') }}"
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <li>
                                                <a href="#">
                                                    <img class="contacts-list-img" src="{{ asset('images/profile_picture_101.jpg') }}"
                                                        alt="User Avatar">
