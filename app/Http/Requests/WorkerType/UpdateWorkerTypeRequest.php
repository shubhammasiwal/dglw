...
namespace App\Http\Requests\WorkerType;

use App\Models\WorkerType;
use Illuminate\Validation\Rule;
use Illuminate\Foundation\Http\FormRequest;

class UpdateWorkerTypeRequest extends FormRequest
{
    /**
    ...
    {
        $id = $this->route('worker_type');
        $worker_type = WorkerType::find($id);
        $code_directory_id = $worker_type?->code_directory_id;
