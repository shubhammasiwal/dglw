...
namespace App\Http\Requests\WorkerRelationship;

use Illuminate\Validation\Rule;
use App\Models\WorkerRelationship;
use Illuminate\Foundation\Http\FormRequest;

class UpdateWorkerRelationshipRequest extends FormRequest
{
    /**
    ...
    {
        $id = $this->route('worker_relationship');
        $worker_relationship = WorkerRelationship::find($id);
        $code_directory_id = $worker_relationship?->code_directory_id;
